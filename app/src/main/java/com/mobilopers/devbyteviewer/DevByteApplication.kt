...
package com.mobilopers.devbyteviewer

import android.app.Application
import android.os.Build
import androidx.work.*
import com.mobilopers.devbyteviewer.work.RefreshDataWork
...
class DevByteApplication : Application() {
    ...
    val applicationScope: CoroutineScope = CoroutineScope(Dispatchers.Default)
